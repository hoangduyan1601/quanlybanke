        ...
        <div class="card border-0 shadow-sm rounded-4 p-4">
            ...
            <div class="mt-4 p-3 bg-light rounded-3">
                ...
                <ul class="extra-small text-muted ps-3 mb-0">
                    <li>Nếu không tìm thấy tác giả, hãy <a href="{{ route('admin.thuonghieu.create') }}" class="text-primary text-decoration-none">thêm mới tác giả</a> trước.</li>
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header bg-white border-0 py-4 px-4 d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary-subtle text-primary px-3 rounded-pill">{{ $product->ThuongHieus->count() }} tác giả</span>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pe-4 text-end">
                                <form action="{{ route('admin.sanpham.remove_author', ['sp_id' => $product->MaSP, 'tg_id' => $tg->Mathuonghieu]) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn gỡ tác giả này khỏi sản phẩm?')">
                                    @csrf
                                    @method('DELETE')
